# Reference:
# [1] Yerlan Idelbayev https://github.com/akamaster/pytorch_resnet_cifar10/blob/master/resnet.py
...
class ResNet(torch.nn.Module):
    def __init__(self, block=BasicBlock, num_blocks=[3,3,3], num_classes=10, in_chan=3, padd=1):
        super(ResNet, self).__init__()
        self.in_planes = 16

        self.conv1 = torch.nn.Conv2d(in_chan, 16, kernel_size=3, stride=1, padding=padd, bias=False)
