...
class Model():
  def __init__(self, activation='tanh',
    ...
    self.trainer = Treiner_Tester(self.net_, number_of_epochs, self.parser, loss, gpu, batch_s, opt, lerning_rate)
...
#   trainer_tester_instance = Treiner_Tester(LeNet6(padd = 3, in_chan = 1), 30, parse_instance)
